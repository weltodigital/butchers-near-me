          ...
          <div className="bg-white rounded-lg shadow-sm p-8 prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Butchers Near Me ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website findabutchers.co.uk (the "Service").
              </p>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  ...
                  Email: privacy@findabutchers.co.uk<br />
